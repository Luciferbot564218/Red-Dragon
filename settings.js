...
global.alivemsg = `My name is BAD LUCIFER BOT🔥
My Creator is BAD LUCIFER😎` //Costomize Alive Message (type your message in `` )
...
global.botname = ' ☬BAD LUCIFER༒BOT' //Bot Name
...
global.packname = '☬BAD LUCIFER༒BOT࿐' //Bot Pacage Name
global.author = '😎BAD LUCIFER❯❯' //Author Name
global.prefa = ['','!','.','😂','❤','💠'] //Command Prefix eg:(.alive ,alive 😂alive)
global.sessionName = 'session' //Session Name!
global.sp = '⭔' //A Charactor
global.dragonemoji = '🧩' // Menu emoji
global.footer = '©_BAD LUCIFER.' //In list menu
