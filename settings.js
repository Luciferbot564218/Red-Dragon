...
global.alivemsg = `My name is BAD LUCIFER🔥
My Creator is BAD_LUCIFER😎` //Costomize Alive Message (type your message in `I'M ONLINE NOW. > TYPE .menu FOR COMMAND LIST    ~ENJOY~` )
